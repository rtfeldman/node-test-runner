...
function generateMainModule(
  ...
  const mainPath = path.join(
    getGeneratedSrcDir(generatedCodeDir),
    'Test',
    'Generated'
  );
  ...
  //
  // my-project-name/elm-stuff/generated-code/elm-community/elm-test/0.19.1-revisionX/src/Test/Generated/Main36138116.elm
