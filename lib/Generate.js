 ...
 * @typedef { {
    ...
    unitTests: Array<{ labels: Array<string>, expectation: string, debugLogs: string }>,
    fuzzTests: Array<{ labels: Array<string>, expectation: string, debugLogs: string }>,
  } } CachedTests
 *
 * @param { Module } previousRunModule
...
function generatePreviousRunModule(previousRunModule, previousRun) {
  /**
   * @param { { labels: Array<string>, expectation: string, debugLogs: string } } data
   * @returns
   */
