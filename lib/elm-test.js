...
function generatePackageJson(filePathArgs) {
  ...
  // TODO: could read this from path.resolve(path.join(__dirname, "..", "elm.json"))
  var requiredByNodeTestRunner = {
    dependencies: {
      "elm/random": "1.0.0",
      "elm/time": "1.0.0",
      "elm/json": "1.0.0"
    ...
    "transitive-dependencies": {
      ...
      "eeue56/elm-lazy-list": "2.0.0",
      "eeue56/elm-shrink": "2.0.0",
      "elm/html": "1.0.0", // TODO: elm-lazy shouldn't actually depend on this
      "elm/virtual-dom": "1.0.0" // TODO: elm-lazy shouldn't actually depend on this
    }
  };

  addDependencies(requiredByNodeTestRunner.dependencies);
  addDependencies(projectElmJson.dependencies);
  addDependencies(projectElmJson["test-dependencies"]);
  addTransitiveDependencies(requiredByNodeTestRunner["transitive-dependencies"]);
  if (!isPackageProject) {
