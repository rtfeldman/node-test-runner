...
function runElmTest() {
  ...
  var returnValues = Generate.generateElmJson(pathToElmBinary, filePathArgs);
...
function generateAndRunTests(tests, filePathArgs, generatedCodeDir, generatedSrc, getGlobs) {
