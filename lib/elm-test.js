...
function generatePackageJson(filePathArgs) {
  ...
  addIndirectDependencies(nodeTestRunnerElmJson["do-not-edit-this-by-hand"]["transitive-dependencies"]);
  if (isPackageProject) {
    ...
    addIndirectDependencies(projectElmJson["do-not-edit-this-by-hand"]["transitive-dependencies"]);
  }
