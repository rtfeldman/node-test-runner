...
async function make(
  ...
  Generate.generateElmJson(projectRootDir, generatedCodeDir, elmJson);
  ...
  async function run() {
    try {
      ...
      if (watcher !== undefined) {
        const nextGlobsToWatch = getGlobsToWatch(elmJson);
      ...
      const isPackageProject = elmJson.type === 'package';
