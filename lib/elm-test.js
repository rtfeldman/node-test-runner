...
if (nodeMajorVersion < 10) {
  ...
  console.error(
    'elm-test requires node v10.0.0 or greater - upgrade the installed version of node and try again'
  );
  process.exit(1);
}
...
// This variable is _always_ overwritten above but will still have a default
// value here to please Flow.
let pathToElmBinary = 'elm';
