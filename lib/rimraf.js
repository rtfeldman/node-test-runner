...
//
// License copied from:
// https://github.com/nodejs/node/blob/feff38501a69f9860a6bc8f6647c3d5a2c8bc1c9/LICENSE#L1590-L1607
...
function rmdirSyncRecursive(dirPath) {
  return rmdirSync.length === 1
    ? rimrafSync(toNamespacedPath(dirPath))
