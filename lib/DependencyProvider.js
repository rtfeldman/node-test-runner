...
class OfflineAvailableVersionLister {
  ...
  list(pkg, orderConstraints) {
    ...
    return applyOrderConstraints(offlineVersions, orderConstraints);
  }
}
...
class DependencyProvider {
   ...
   * @returns { string }
   */
  solveOffline(elmJson, useTest, extra, packageStrategy) {
   ...
   * @returns { string }
   */
  solveOnline(elmJson, useTest, extra, packageStrategy) {
