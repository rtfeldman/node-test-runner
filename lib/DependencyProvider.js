...
function listAvailableVersionsOnline(pkg /*: string */) /*: Array<string> */ {
  ...
  // TODO: sorting string versions like "12.0.1" is wrong...
  // We need to sort them with a semver order.
...
function listAvailableVersionsOffline(pkg /*: string */) /*: Array<string> */ {
  ...
  // TODO: the order of the versions folders might not correspond to the semver order!
  // We need to fix that.
