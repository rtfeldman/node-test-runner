...
class OnlineAvailableVersionLister {
  ...
  list(pkg /*: string */, indirectDeps /*: void | Map<string, string>*/) /*: Array<string> */ {
    const memoVersions = this.memoCache.get(pkg);
    if (memoVersions !== undefined) {
      return prioritizePinnedIndirectVersion(memoVersions, indirectDeps?.get(pkg));
    }
    ...
    return prioritizePinnedIndirectVersion(allVersions, indirectDeps?.get(pkg));
  }
}
...
class OfflineAvailableVersionLister {
  ...
  list(pkg /*: string */, indirectDeps /*: void | Map<string, string>*/) /*: Array<string> */ {
    ...
    return prioritizePinnedIndirectVersion(offlineVersions, indirectDeps?.get(pkg));
  }
}
...
function prioritizePinnedIndirectVersion(
  ...
  pinnedVersion /*: void | string */) /*: Array<string> */ {
