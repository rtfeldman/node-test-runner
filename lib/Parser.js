...
function extractExposedPossiblyTests(
  ...
  return new Promise((resolve, reject) => {
    ...
    function flush(token /*: typeof Token | void */) /*: void */ {
      if (
      ...
      if (token !== undefined) {
        const error = onParserToken(token);
        if (error !== undefined) {
          flushError(error);
          return;
        }
    ...
    function flushError(
      error /*: SyntaxError | CriticalSyntaxError | 'StopParsing' */
    ) /*: void */ {
      if (error instanceof CriticalSyntaxError) {
        reject(
          new CriticalSyntaxError(
    ...
    function onParserToken(
      token /*: typeof Token */
    ) /*: SyntaxError | CriticalSyntaxError | 'StopParsing' | void */ {
...
class CriticalSyntaxError extends SyntaxError {}
        ...
        case 'Other':
          switch (token.value) {
            ...
            case 'effect': // Not a reserved word, so this is a LowerName.
              return new CriticalSyntaxError(
