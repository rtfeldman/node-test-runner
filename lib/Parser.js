...
function extractExposedPossiblyTests(
  ...
  return new Promise((resolve, reject) => {
    ...
    function flushError(error /*: typeof OnParserTokenResult */) /*: void */ {
      switch (error.tag) {
        case 'ParseError':
        ...
        case 'CriticalParseError':
          reject({
            ...
            message: `This file is problematic:\n\n${filePath}\n\n${error.message}`,
          });
          break;
...
function expected(
  ...
  return {
    tag: 'ParseError',
    message: `Expected ${expectedDescription} but got: ${JSON.stringify(
      actual
    )}`,
  };
}
