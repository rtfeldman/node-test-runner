...
function compileAll(
  ...
  return compileSources(
    ...
    const testElmJson = path.join(testRootDir, 'elm.json');
    const testSourceDirs = fs.readJsonSync(testElmJson)['source-directories'];
  ...
  // TODO generate elmJson and Main
  // TODO compile generated Main for tests
}
