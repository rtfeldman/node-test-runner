...
function mtime(dir) {
  ...
  try {
    const stats = fs.statSync(elmJsonPath);
...
module.exports = {
  ELM_TEST_PACKAGE: ELM_TEST_PACKAGE,
  getPath: getPath,
  mtime: mtime,
  parseDirectAndIndirectDependencies: parseDirectAndIndirectDependencies,
  read: read,
  requireElmTestPackage: requireElmTestPackage,
  write: write,
};
