...
async function runTests(
  ...
  if (unstableUseTestMaster) {
    console.log('Using the master version of elm-explorations/test');
    console.log('Note you might need to rm -rf ~/.elm and/or ./elm-stuff afterwards.');
    await Install.installUnstableTestMaster();
  }
