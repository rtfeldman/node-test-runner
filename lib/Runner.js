...
) /*: ({name: string, tests: Array<string>}) => Array<{name: string, tests: Array<string>, path: string}> */ {
...
function findTests(
  ...
  testSourceDirs /*: Array<string> */,
  verbose /*: boolean */
) /*: Promise<Array<{tests: Array<string>, exactDeps: Array<string>}>> */ {
    ...
    function finish() {
      ...
      proc.on('close', function(code) {
        ...
        var filteredModules = _.flatMap(modules, function(mod) {
          var eligible = _.flatMap(_.toPairs(mod.interface.values), function(
            pair
          ) {
            var name = pair[0];
