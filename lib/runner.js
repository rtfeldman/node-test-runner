...
function repositoryToNativePackageName(repository /*:string*/) {
  repository = repository || "https://github.com/user/project.git"; // TODO: we shouldn't depend on package name at all in Elm 0.19
...
function findTests(
  ...
  return new Promise(function(resolve, reject) {
    function finish() {
      console.error(global.process.cwd());
      console.error(elmPackageJsonPath);
      // NOTE: must be cd'd into elmPackageJsonPath when running elm-interface-to-json
      var process = spawn(readElmiPath, []);
      var jsonStr = "";
      var stderrStr = "";
