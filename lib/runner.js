...
function copyNativeSrcFiles(newPackageName/*:string*/, srcPath/*:string*/, dest/*:string*/) {
...
function repositoryToNativePackageName(repository/*:string*/) {
  ...
  if (matches instanceof Array) {
    ...
    if (repoName.indexOf('.') >= 0) {
      console.error("Repository name '" + repositoryName + "' includes the dot symbol, this can cause issues with 'elm-make'");
      console.error("Please rename the repository or elm-test will not be able to run the tests.");
...
function evalElmCode (args/*:Array<string>*/, report/*:string*/, compiledCode/*:string*/) {
...
function toPathsAndModules(testFilePaths/*:Array<string>*/, testSourceDirs/*:Array<string>*/) {
  ...
  return function(testModule) {
    ...
    for (var pathIndex=0; pathIndex < paths.length; pathIndex++) {
      ...
      for (var testSourceDirIndex=0; testSourceDirIndex < testSourceDirs.length; testSourceDirIndex++) {
...
function findTests(elmPackageJsonPath/*: string*/, testFilePaths/*: Array<string>*/, sourceDirs/*: Array<string>*/) {
