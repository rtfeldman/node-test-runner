...
/**
 * @param { Array<string> } fileGlobs
 * @param { string } projectRootDir
 * @returns { Array<string> }
 */
function resolveGlobs(fileGlobs, projectRootDir) {
  return Array.from(
    new Set(
 ...
 * @returns { Array<string> }
 */
function resolveCliArgGlob(fileGlob, projectRootDir) {
 ...
 * @returns { Array<string> }
 */
function findAllElmFilesInDir(dir) {
  return globSync('**/*.elm', {
    cwd: dir,
    caseSensitiveMatch: false,
    absolute: true,
 ...
 * @param { typeof Project.Project } project
...
/**
 * @param { TODO } filePath, isPackageProject
 * @returns { TODO }
 */
...
/**
 * @param { TODO } filePath, sourceDir, moduleName
 * @returns { TODO }
 */
