// Scroll to the end of the file for instructions on how to build this file.
var $$$testRunner$run;
...
var _rtfeldman$node_test_runner$Test_Reporter_Chalk$failureToChalk = function (_p2) {
	...
	return _elm_lang$core$String$isEmpty(_p4) ? _elm_lang$core$Native_List.fromArray(
...
var _rtfeldman$node_test_runner$Test_Runner_Node_App$decodeReport = function (decoder) {
	return A2(
		...
		function (str) {
			...
			switch (_p0) {
				case 'json':
					return _elm_lang$core$Result$Ok(_rtfeldman$node_test_runner$Test_Reporter_Reporter$JsonReport);
				case 'chalk':
					return _elm_lang$core$Result$Ok(_rtfeldman$node_test_runner$Test_Reporter_Reporter$ChalkReport);
				default:
					return _elm_lang$core$Result$Err(
					...
					return _elm_lang$core$Native_List.fromArray(
						[
							...
							return {
								ctor: '_Tuple2',
								_0: labels,
								_1: _elm_community$elm_test$Test_Runner$run(_p1._0)
							};
						}
						]);
				case 'Labeled':
					var _v3 = A2(_elm_lang$core$List_ops['::'], _p1._0, labels),
						_v4 = _p1._1;
					labels = _v3;
					runner = _v4;
		...
		if (_p5.ctor === 'Uninitialized') {
			...
			if (_p6.ctor === 'Init') {
				...
				var numericSeed = function () {
					var _p7 = _p5._1.maybeInitialSeed;
					if (_p7.ctor === 'Just') {
						return _p7._0;
					} else {
						return _rtfeldman$node_test_runner$Test_Runner_Node_App$timeToNumericSeed(_p9);
					}
				}();
				...
				var thunks = _rtfeldman$node_test_runner$Test_Runner_Node_App$toThunks(
					A3(_elm_community$elm_test$Test_Runner$fromTest, _p5._1.runs, seed, _p5._1.test));
				var _p8 = _p5._1.init(
					{initialSeed: numericSeed, startTime: _p9, thunks: thunks, report: _p5._1.report});
				var subModel = _p8._0;
				var subCmd = _p8._1;
				return {
					ctor: '_Tuple2',
					_0: A2(_rtfeldman$node_test_runner$Test_Runner_Node_App$Initialized, _p5._0, subModel),
			...
			if (_p11.ctor === 'SubMsg') {
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_rtfeldman$node_test_runner$Test_Runner_Node_App$Initialized, _p14, newModel),
		...
		var init = function (args) {
				...
				if (_p17._0.ctor === 'Err') {
					return _elm_lang$core$Native_Utils.crashCase(
						'Test.Runner.Node.App',
						{
							...
							end: {line: 224, column: 48}
						},
						_p17)(
						A2(_elm_lang$core$Basics_ops['++'], 'Invalid --seed argument: ', _p17._0._0));
				} else {
					if (_p17._0._0._0.ctor === 'Just') {
						if (_p17._1.ctor === 'Just') {
							var _p20 = _p17._1._0;
							var _p19 = _p17._0._0._0._0;
							return _elm_lang$core$Native_Utils.eq(_p19, _p20) ? {ctor: '_Tuple2', _0: _p22, _1: _p17._0._0._1} : _elm_lang$core$Native_Utils.crash(
								'Test.Runner.Node.App',
								{
							...
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Maybe$Just(_p17._0._0._0._0),
								_1: _p17._0._0._1
							};
						}
					} else {
						if (_p17._1.ctor === 'Just') {
							return {ctor: '_Tuple2', _0: _p22, _1: _p17._0._0._1};
						} else {
							return {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _p17._0._0._1};
						}
					}
				}
			}();
			...
			return {
				...
				_0: A2(
					...
					appOpts.update,
					{
						maybeInitialSeed: _elm_lang$core$Basics$fst(initArgs),
						report: _elm_lang$core$Basics$snd(initArgs),
						runs: _p16.runs,
						test: test,
						init: appOpts.init
					}),
		...
		switch (_p3.ctor) {
			...
			case 'Complete':
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					_p9,
					{
						completed: A2(_elm_lang$core$List_ops['::'], result, _p9.completed)
					});
								...
								_1: _elm_lang$core$Json_Encode$object(
									_elm_lang$core$Native_List.fromArray(
										[
											...
											{ctor: '_Tuple2', _0: 'message', _1: _p5._0}
										]))
							});
					} else {
				...
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						_elm_lang$core$Native_List.fromArray(
							[reportCmd, _rtfeldman$node_test_runner$Test_Runner_Node$dispatch]))
				};
			default:
				var _p6 = _p9.queue;
				if (_p6.ctor === '[]') {
...
//
// The purpose of this file is to let the end user run tests without having to
// specify main or ports. The test runner will compile the target Tests.elm
// file, read it into memory, append this file while it's still in memory,
// add some extra info about which tests to run, and eval the result.
//
// 1. Run elm-make --output=foo.js EmptyTests.elm
// 2. Replace extras.js (this file) with the contents of foo.js.
// 3. Add this line to the top of the revised file: var $$$testRunner$run;
// 4. Comment out the section that begins: var Elm = {};
// 5. Comment out everything between: var _elm_lang$core$Native_Platform = function() {
//    and: var _elm_lang$core$Native_Scheduler = function() {
// 6. Add the content below.
