// ported from https://github.com/elm-lang/elm-compiler/blob/375ed593e43cf73886328091afbf8688a094cb3f/src/Reporting/Error/Syntax.hs

use elm_compiler::reporting::region;

// ALL SYNTAX ERRORS


enum Error {
    Parse(Option<region::Region>, Problem)
    , BadFunctionName(u64)
    , BadPattern(String)
    ...
    , UnboundTypeVarsInUnion(String, Vec<String>, Vec<String>)
    , UnboundTypeVarsInAlias(String, Vec<String>, Vec<String>)
    , UnusedTypeVarsInAlias(String, Vec<String>, Vec<String>)
    , MessyTypeVarsInAlias(String, Vec<String>, Vec<String>, Vec<String>)
}
...
pub enum ParseError { ParseError(u64, u64, Problem) }
...
pub enum Problem {
  ...
  , Theories(ContextStack, Vec<Theory>)
  }
...
enum EscapeProblem
  ...
  , UnicodeSyntax
  , UnicodeRange
  , UnicodeLength(u64, String)
  }


enum BadOp  { HasType , Equals , Arrow , Pipe , Dot }
...
pub type ContextStack = Vec<(Context, region::Position)>;
